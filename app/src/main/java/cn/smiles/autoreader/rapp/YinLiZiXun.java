...
public class YinLiZiXun extends RApp {

    private final int READNUMBER = 16;//阅读文章数量

    public YinLiZiXun() {
        appName = "引力资讯";
        packageName = "com.donews.firsthot";
        launchIntent = "com.donews.firsthot/.common.activitys.SplashActivity";
    ...
    protected void checkInReward() {
        ...
        KTools.sleep(3);
        KPhone.click(631, 1248);
        KTools.sleep(3);
        KPhone.click(666, 219);
        KTools.sleep(5);
        KPhone.pressBackButton();
        refreshList();
    }
