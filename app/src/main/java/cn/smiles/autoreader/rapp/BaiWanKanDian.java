...
public class BaiWanKanDian extends RApp {

    private final int READNUMBER = 16;//阅读文章数量

    public BaiWanKanDian() {
        appName = "百万看点";
        packageName = "com.tenyou0574.toutiao";
        launchIntent = "com.tenyou0574.toutiao/com.manling.module.activity.StartActivity";
