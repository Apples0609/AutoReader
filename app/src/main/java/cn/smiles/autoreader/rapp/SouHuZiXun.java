...
public class SouHuZiXun extends RApp {
    ...
    public SouHuZiXun() {
        ...
        launchIntent = "com.sohu.infonews/com.sohu.quicknews.splashModel.activity.SplashActivity";
    ...
    protected void checkInReward() {
        ...
        KTools.sleep(3);
        KPhone.click(610, 1229);
        KTools.sleep(3);
        KPhone.click(137, 335);
        KTools.sleep(3);
        KPhone.pressBackButton();
        refreshList();
    }
